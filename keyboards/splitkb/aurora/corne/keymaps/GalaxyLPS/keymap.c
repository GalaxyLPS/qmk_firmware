...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_UPPER] = LAYOUT_split_3x6_3(
        ...
        _______, _______, LSFT(KC_SPC),                         LSFT(KC_ENT), _______, _______
    ),

    /* Symbol Layer */
    [_SYMBOL] = LAYOUT_split_3x6_3(
        _______, DE_EURO, DE_CIRC, DE_LBRC, DE_RBRC, DE_UNDS,                      DE_EXLM, DE_LABK, DE_RABK, DE_EQL, DE_AMPR, DE_AT,
        _______, ALGR(DE_SS), DE_SLSH, DE_LCBR, DE_RCBR, DE_ASTR,                      DE_QUES, DE_LPRN, DE_RPRN, DE_MINS, DE_COLN, _______,
    ...
    [_NAV] = LAYOUT_split_3x6_3(
        _______, _______, KC_P7,   KC_P8,   KC_P9,   KC_P0,                        _______, _______, _______, _______, _______, _______,
        KC_PSCR, _______, KC_P4,   KC_P5,   KC_P6,   KC_DEL,                       KC_BSPC, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______,
        KC_LCTL, _______, KC_P1,   KC_P2,   KC_P3,   TOG_NUM,                      _______, _______, _______, _______, _______, _______,
        _______, _______, KC_TAB,                                                 KC_ESC,  KC_END,  _______
    ),

    /* Control Layer */
    [_CONTROL] = LAYOUT_split_3x6_3(
        C(KC_J), C(DE_Z), C(DE_Y), C(KC_U), C(KC_A), C(KC_Q),                     C(KC_P), C(KC_B), C(KC_M), C(KC_L), C(KC_F), C(DE_SS),
        _______, C(KC_C), C(KC_S), C(KC_I), C(KC_E), C(KC_O),                     C(KC_D), C(KC_T), C(KC_N), C(KC_R), C(KC_H), _______,
    ...
    [_ALT] = LAYOUT_split_3x6_3(
        ...
        _______, A(KC_C), A(KC_S), A(KC_I), A(KC_E), A(KC_O),                     A(KC_D), A(KC_T), A(KC_N), A(KC_R), A(KC_H), _______,
        _______, A(KC_V), A(KC_X), A(DE_UDIA), A(DE_ADIA), A(DE_ODIA),              A(KC_W), A(KC_G), A(KC_COMM), A(KC_DOT), A(KC_K), _______,
        _______, _______, _______,                                                 _______, _______, _______
    ),
